...
public class Q3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        question.setText("Q3: Which one of these is proof of a chemical change?");
        ...
        b1.setText("A: The Object is Cut");
        ...
        b2.setText("B: Changing the Shape");
        ...
        b3.setText("C: Gas Released");

        buttonGroup1.add(b4);
        b4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        b4.setText("D: Change of State");
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        if(!b1.isSelected() && !b2.isSelected() && !b3.isSelected() && !b4.isSelected()){
            ...
            if(b1.isSelected())
            {
                Answer.setText("Incorrect, the correct answer was c!");
