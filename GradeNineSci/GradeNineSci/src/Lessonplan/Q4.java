...
public class Q4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        question.setText("Q4: Which one of these is a physical property?");
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        if(!b1.isSelected() && !b2.isSelected() && !b3.isSelected() && !b4.isSelected()){
            ...
            if(b1.isSelected())
            {
                Answer.setText("Incorrect, the correct answer was d!");
